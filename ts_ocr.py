...
def ts_anpr_init():
    # IMG_PATH = '../img/'
    # LIB_PATH = getLibPath()
    LIB_PATH = ".\\ts-anpr\\windows-x86_64\\tsanpr.dll"
    ...
    img_path = "C:\\Users\\smhrd\\Desktop\\EasyOCR\\anpr_test.png"
    ...
    # 픽셀 버퍼 입력으로 차번 인식
    result = lib.anpr_read_pixels(bytes(img), width, height, 0, 'RGB'.encode('utf-8'), "text".encode('utf-8'), "v".encode('utf-8'))
