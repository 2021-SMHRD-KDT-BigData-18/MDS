					...
					<div class="checkbox-group">
						<div class="checkbox">
							<label class="checkbox-wrapper">
								<input type="checkbox" id="data_car" class="datachkbx" type="checkbox" name="dataanalyze" value="car" onclick="getChkbxVal(this)" checked="true"/> 
						...
						<div class="checkbox">
							<label class="checkbox-wrapper">
								<input type="checkbox" id="data_hum" class="datachkbx" name="dataanalyze" value="human" onclick="getChkbxVal(this)" checked="true"/>
								<span class="checkbox-tile">
									<span class="checkbox-icon">
